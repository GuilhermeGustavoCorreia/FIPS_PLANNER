...
from    previsao_trens.packages.CONFIGURACAO.INTEGRACAO_PLANNER_OFFLINE_LER       import    LER_DADOS
    ...
    if request.method == 'POST':
        ...
        with transaction.atomic():
            ...
            if FORM_NOVO_TREM.is_valid(): 
                ...
                TREM_OBJETO = FORM_NOVO_TREM.save(commit=False)
                TREM_OBJETO.created_by = request.user
                TREM_OBJETO.save()
